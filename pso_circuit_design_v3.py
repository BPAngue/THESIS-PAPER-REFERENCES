...
num_rows = problem4.num_rows  # Number of internal gates
...
final_formulas = problem4.get_circuit_formula(global_best_particle.position)
circuit_matrix, output_array = problem4.decode_particle(global_best_particle.position)
...
print(f"Correct outputs: {global_best_particle.num_equal_tt}/{problem4.truth_table.total_outputs}")
